...
print(sp)
# чезез zip() сравниваем 2 списка исходный и его срез со сдвигом и выводим по условию
...
print(sp)
# считаем количество вхождений элемента и, если оно = 1, то выводим его
