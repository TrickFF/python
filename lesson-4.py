...
def my_func(p1, p2, p3):
      ...
      p.append(p2)
      p.append(p3)
      print(f'Сумма наибольших 2х из введенных чисел - {sum(p) - min(p)}')
...
while e == 0:
    ...
    num = numbers.split()
    for i in num:
        if i.isdigit() == False: # если в строке указано нечисловое значение, то ввод строки заново
...
#         e = 1
#     for i in num:
#         if i.isdigit() == False: # если в строке указано нечисловое значение, то звершаем работу
#               print('Вы ввели нечисловое значение! Данные этого ввода не учитываются!')
#               print(f'Общая сумма ранее введеных чисел = {total}')
#               exit()
#     print(f'Сумма данных чисел = {sum_num(num)}')
#     total += sum_num(num)
#
